...
public class KyberAlgorithm
{
    ...
    public void decapsulate()
    {
        try
        {
            ...
            Util.arrayCopyNonAtomic(EEPROM32B_1, (short)0, secretKey, (short)0, (short)32);//end EEPROM32B_1
        }
        catch (Exception e)
        {
            ISOException.throwIt(ISO7816.SW_UNKNOWN);
    ...
    public void generateKyberKeys() throws Exception
    {
        ...
        this.packPublicKey(this.EEPROM384S_X_PARAMS_K_3, this.EEPROM32B_1, paramsK);
    }
